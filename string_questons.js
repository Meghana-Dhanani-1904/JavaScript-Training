...
// Which method is used to find the position of a specified value within a string?//indexof
// How would you concatenate two strings using a string method?//with the help of "concate" sting method
// Which method would you use to extract a specific portion of a string?//substring

// How can you replace a specific value with another value within a string using a method?//replace
// Which method would you use to split a string into an array of substrings based on a specified separator?//.substring().split()
// How would you remove leading and trailing whitespace from a string using a method?//trim
// Which method is used to search for a specified pattern and return the first occurrence in a string?//substr
// How can you check if a string starts with a specific value using a string method?//startWith
...
// console.log(sentence.indexOf("JavaScript"));//7 it will only give first letter's index
...
// // console.log(text.substring(7));//World! beecause we haven't provide lenth to the string
...
// const str = "Hello, World!";
// console.log(str.charAt(13));// empty
...
// console.log(sentence.split(" ").length);//'JavaScript','is','powerful!' 
...
//  const sentence = "JavaScript is amazing!";
// console.log(sentence.slice(4, -10));//Script i
...
//  const text = "Hello,World!";
// console.log(text.substring(7, 2));//llo,W

//  const sentence = "JavaScript is cool!";
// console.log(sentence.concat(" I love it!"));//JavaScript is cool! I love it!

//  const str = "Hello, World!";
// console.log(str.toUpperCase().charAt(8));//O
